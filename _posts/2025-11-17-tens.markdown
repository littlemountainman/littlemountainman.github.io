...
The output stage is where the magic happens. Here, the boosted 32V rail is gated by **MOSFETs (DMN6075S)** and **BJTs (FZT853, MMBT2222)** to deliver controlled pulses to the electrodes.
...
- Thumb, Index, Middle, Ring, Pinky each get their own channel  
- Palm is the common ground reference  
...
Most importantly, it’s not just a gadget.